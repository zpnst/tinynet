...
Давайте посмотрим как изменится вывод команды pstree
...
Рассмотрим картинки для каждого из видов топологии, для простоты возьмём конфигурацию с четырьмя роутерами, так как топологию мы формируем только на уровне роутеров и чтобы не захламлять картинку другими устройствами.
